...
public record AnalysisResult(int schemaVersion, String engineVersion, List<String> starts, MapperState assumption,
    ...
    public static AnalysisResult read(String json) {
        ...
        if(!root.isJsonObject() || !root.getAsJsonObject().has("engineVersion") ||
