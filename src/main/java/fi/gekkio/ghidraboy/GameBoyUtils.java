...
public final class GameBoyUtils {
  ...
  public static void addHardwareBlocks(Program program, GameBoyKind kind, MessageLog log) {
    ...
    if (kind == GameBoyKind.CGB) {
      ...
      for (int i = 1; i <= 7; i++) {
        createUninitializedBlock(
            ...
            true,
            "wram" + i,
            as.getAddress(0xd000),
            0x1000,
            "Work RAM (bank %d)".formatted(i),
            source,
            true,
            true,
            true,
    ...
    createUninitializedBlock(
        ...
        false,
        "oam",
        as.getAddress(0xfe00),
        0xa0,
        "Object Attribute Memory RAM",
        source,
        true,
        true,
        false,
  ...
  public static void populateHardwareBlocks(Program program, GameBoyKind kind)
  ...
  private static void addHwData(Program program, String name, Address address, DataType dataType)
      throws CodeUnitInsertionException, InvalidInputException {
    createData(
        program,
        address,
