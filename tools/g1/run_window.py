...
def main():
    ...
    p.add_argument('--project-name',required=True);p.add_argument('--mode',choices=['readiness','initial','full','reopen'],required=True)
    ...
    receipt={'argv':cmd,'start_ns':time.time_ns(),'mode':a.mode,'no_setup_in_launcher':True}
