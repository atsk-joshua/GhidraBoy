...
report['ready_for_generic_tests']=report['native'] and report['ghidra']=='12.1.3' and report['loopback'] and report['java_usable'] and report.get('ghidratrace_client')=='12.1' and report.get('protobuf')=='6.31.0' and len(report['sm83_definitions'])==1
